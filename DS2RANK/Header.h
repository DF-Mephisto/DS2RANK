...
void CheckWeapon(vector<DWORD32>*, vector<int>*, vector<int>*, Trainer*, int*, int, int, int);
void CheckArmor(vector<DWORD32>*, vector<int>*, Trainer*, int*, int, int);
void CheckRing(vector<DWORD32>*, Trainer*, int*, int);
...
template<class T> void FillEquipVector(wstringstream*, vector<T>*, int);
...
void LoadDatas(LPCSTR, LPCSTR, HINSTANCE, wstring);
...
void ShowDataBtn(HWND*, int*, int*, int);
void DetectDataBtn(bool*, int*, int*, int);

void HideBtn(HWND*, int Counts);
void DestroyBtn(HWND*, int Counts);

void ChangeEquipCount(WPARAM, int*, int*, int*, int);